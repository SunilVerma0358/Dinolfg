      ...
      <div className=" max-w-[1140px] px-3 container mx-auto pt-24 sm:pt-28 md:pt-40 pb-24 sm:pb-28 md:pb-36">
        ...
        >
          <div className=" flex flex-row flex-wrap -mx-3 ">
            <div className="w-9/12 px-3 pt-7 md:pt-0">
            ...
            <div className="w-3/12 px-3">
              <div className="max-w-[200px] sm:max-w-[255px] lg:max-w-[255px] max-h-full sm:max-h-[323px] md:absolute bottom-[-0%] right-[24px] mx-auto md:mx-0 z-[-1]">
                <img
                  className="w-full h-full opacity-25 lg:opacity-100"
                  src={RightCycle}
                  alt="RightCycle"
                />
              </div>
        ...
        >
          <div className="flex flex-row flex-wrap -mx-3">
            <div className=" w-full md:w-3/12 px-3 md:relative">
              <div className="lg:absolute bottom-[-110%] lg:bottom-[-91%] right-0 max-w-[200px] md:max-w-[267px] max-h-[280px]  mx-auto md:mx-0">
                <img className="w-full" src={Bike} alt="bike" />
              </div>
            </div>
            <div className=" w-full md:w-9/12 px-3 pt-8 md:pt-0">
              <p className=" font-Balsamiq font-normal text-white  text-lg sm:text-[24px] md:text-[28px] lg:text-[32px] leading-[25px] sm:leading-[32px] md:leading-[38.4px] text-center md:text-end ">
