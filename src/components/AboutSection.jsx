    ...
    <div id="About" className="bg-[#09655A] relative z-20 ">
      <div className="max-w-[1135px] mx-auto px-3 container sm:pt-[70px] pb-32">
        <div className="max-w-[599px] mx-auto">
          ...
          <p className=" font-Balsamiq font-normal text-white text-lg sm:text-xl md:text-2xl leading-[28.8px] text-center pt-[42px]">
            $DINO is a meme coin with very strong utility.
          </p>
          <p className=" font-Balsamiq font-normal text-white text-lg sm:text-xl md:text-2xl leading-[28.8px] text-center pt-[18px]">
          ...
          <p className=" font-Balsamiq font-normal text-white text-lg sm:text-xl md:text-2xl leading-[28.8px] text-center pt-[10px]">
            We want to bring a lot of usecases and utility to $DINO holders,
            just sit back and relax.
          </p>
          <p className=" font-Balsamiq font-normal text-white text-lg sm:text-xl md:text-2xl leading-[28.8px] text-center pt-[14px]">
      ...
      <div className=" max-w-[200px] lg:max-w-[294px] h-[421px] absolute right-1 bottom-[-10%] lg:bottom-[10%] z-[-1]">
        <img src={AboutSectionRight} alt="about" />
      </div>
      <div className=" max-w-[180px] lg:max-w-[200px]  absolute right-1 bottom-[-10%] lg:bottom-0 z-[-1] animate-bounce2">
